...
const Add_to_card = () => {
    ...
    return (
        ...
        <div className="card-popular add-2rem" >
            {card.map((iteam) => (
                <div key={iteam.id} className="card" style={{ position: 'relative' }}>
                    <div className="card-container">
                        ...
                        <div className="price-container">
                            ...
                            <button className="btn padding-5px" onClick={()=>navigate(`/order/${iteam.id}`)}>Place the order</button>
                        </div>
                        <div className="price-container">
                            <button className="btn padding-5px" style={{ backgroundColor: 'green' }} onClick={() => navigate('/')}>
                                Back to home
                            </button>
                            <button className="btn padding-5px" style={{ backgroundColor: 'red' }} onClick={() => removetoCard(iteam.id)}>
                                Remove from cart
                            </button>
                        </div>
                    </div>
